...
Route::group(['prefix' => '/category'], function () {
    ...
    Route::get('/home-cleaner', 'HomeCleanerController@userhomecleaner')->name('user.homecleaner');
    Route::get('/laundry', 'LaundryController@userlaundry')->name('user.laundry');
    Route::get('/les-private', 'LesPrivateController@userlesprivate')->name('user.lesprivate');
    Route::get('/massage', 'MassageController@usermassage')->name('user.massage');
    Route::get('/self-beauty', 'SelfBeautyController@userselfbeauty')->name('user.selfbeauty');
});
...
Route::group(['prefix' => '/admin'], function (){
    ...
    Route::get('/add-entertaiment', 'EntertaimentController@create')->name('create.entertaiment');
    Route::post('/store-entertaiment', 'EntertaimentController@store')->name('store.entertaiment');
    Route::get('/edit-category/{id}', 'EntertaimentController@edit')->name('edit.entertaiment');
    Route::get('/show-category', 'EntertaimentController@show')->name('show.show');
    Route::get('/delete/category/{id}', 'EntertaimentController@destroy')->name('delete.entertaiment');
    ...
    Route::get('/les-private', 'LesPrivateController@index')->name('lesprivate');
    ...
    Route::get('/self-beauty', 'SelfBeautyController@index')->name('selfbeauty');
